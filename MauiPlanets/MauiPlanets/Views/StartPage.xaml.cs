...
namespace MauiPlanets.Views
{
    public partial class StartPage : ContentPage
    {
        ...
        protected override async void OnAppearing()
        {
            ...
            AddPlanetAnimations(parentAnimation);

           
            parentAnimation.Add(0.7, 1, new Animation(v => imgIntro.Opacity = v, 0, 1, Easing.CubicIn));

            
            parentAnimation.Commit(this, "TransitionAnimation", 16, 3000, Easing.Linear, null, null);
        }

        private void AddPlanetAnimations(Animation parentAnimation)
        {
